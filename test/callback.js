...
describe("Server", function () {
  ...
  it("should correct load modules from directory", function () {
    server.loadModules(__dirname + "/modules-callback/", function () {
  ...
  it("should correct work with context", function (done) {
    server.expose("getName", function () {
      this.callback(null, this.name);
    });
  ...
  it("should correct work server.batch", function () {
  ...
  it("should correct work checkAuth function", function (done) {
...
describe("End", function () {
  ...
  it("https server must die!", function () {
    httpsTransport.close();
  });

  it("tcp server must die!", function () {
    tcpTransport.close();
  });

  it("express server must die!", function () {
    expressServer.close();
  });
